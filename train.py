...
ap.add_argument('-d', '--dataset', default=r'E:\HUB\smile-detector\dataset',  
    help='path to the input dataset of faces')
ap.add_argument('-m', '--model', default=r'E:\HUB\smile-detector\model.h5', 
...
for imagePath in sorted(list(paths.list_images(args['dataset']))):
    ...
    label = imagePath.split(os.path.sep)[-2] # C:\Users\Balaji\Documents\Smile-Detector\SMILEs\positives\positives7\3.jpg
